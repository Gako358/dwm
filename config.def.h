...
static const char *altbarclass      = "eww-apps"; /* Alternate bar class name */
...
const char *spcmd2[] = { "st", "-n", "ncmpcpp", "-g", "120x34", "-e", "ncmpcpp", NULL };
const char *spcmd3[] = { "st", "-n", "htop", "-g", "120x34", "-e", "btm", NULL };
...
static const Rule rules[] = {
    ...
    { NULL,       "ncmpcpp",  NULL,       SPTAG(1),     0,           1,             0,                  -1 },
    { NULL,       "htop",     NULL,       SPTAG(2),     0,           1,             0,                  -1 },
};
