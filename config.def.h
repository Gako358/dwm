...
static const char *colors[][3]      = {
	/*					            fg         bg       border   */
	[SchemeNorm]        =	    { col_fg,   col_dark,   col_bg     },
...
static const Rule rules[] = {
	...
	{ "Mailspring",     NULL,       NULL,       1 << 5,       0,             0,            1 },
	{ "lyx",            NULL,       NULL,       1 << 2,       0,             0,            2 },
	{ "Virt-manager",   NULL,       NULL,       1 << 7,       0,             0,            2 },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_dark, "-nf", col_fg, "-sb", col_blue, "-sf", col_bg, NULL };
