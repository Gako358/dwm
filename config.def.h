...
static const Rule rules[] = {
	...
	{ "lyx",            NULL,       NULL,       1 << 4,       0,             0,            2 },
	{ "Virt-manager",   NULL,       NULL,       1 << 6,       0,             0,            2 },
};
...
static const char *scratchpadcmd[] = { "st", "-t", scratchpadname, "-g", "150x55", NULL };
...
static Key keys[] = {
    ...
    // Vanity
	{ ShiftMask,                    XK_h,      incrgaps,       {.i = +1 } },
	{ ShiftMask,                    XK_l,      incrgaps,       {.i = -1 } },
	{ ShiftMask|Mod1Mask,           XK_h,      incrogaps,      {.i = +1 } },
	{ ShiftMask|Mod1Mask,           XK_l,      incrogaps,      {.i = -1 } },
	{ ShiftMask|ControlMask,        XK_h,      incrigaps,      {.i = +1 } },
	{ ShiftMask|ControlMask,        XK_l,      incrigaps,      {.i = -1 } },
	{ ShiftMask,                    XK_0,      togglegaps,     {0} },
	{ ShiftMask|Mod1Mask,           XK_0,      defaultgaps,    {0} },
	{ ShiftMask,                    XK_y,      incrihgaps,     {.i = +1 } },
	{ ShiftMask,                    XK_o,      incrihgaps,     {.i = -1 } },
	{ ShiftMask|Mod1Mask,           XK_y,      incrivgaps,     {.i = +1 } },
	{ ShiftMask|Mod1Mask,           XK_o,      incrivgaps,     {.i = -1 } },
	{ ShiftMask|ControlMask,        XK_y,      incrohgaps,     {.i = +1 } },
	{ ShiftMask|ControlMask,        XK_o,      incrohgaps,     {.i = -1 } },
	{ ShiftMask|MODKEY,             XK_y,      incrovgaps,     {.i = +1 } },
	{ ShiftMask|MODKEY,             XK_o,      incrovgaps,     {.i = -1 } },
