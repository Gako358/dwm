...
const char *spcmd3[] = {"st", "-n", "mutt", "-g", "280x64", "-e", "neomutt", NULL };
const char *spcmd4[] = {"st", "-n", "htop", "-g", "280x64", "-e", "btop", NULL };
const char *spcmd5[] = {"st", "-n", "weechat", "-g", "280x64", "-e", "weechat", NULL };
